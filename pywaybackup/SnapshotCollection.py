...
class SnapshotCollection:
    ...
    def create_full(self, cdxResult):
        ...
        self.CDX_LIST = sorted([{"timestamp": snapshot[0], "url": snapshot[1]} for i, snapshot in enumerate(self.CDX_JSON)], key=lambda k: k['timestamp'], reverse=True)
    ...
    def create_archive_url(cls, timestamp: str, url: str) -> str:
        url_type = cls.get_url_filetype(url)
